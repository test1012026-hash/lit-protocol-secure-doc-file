...
export const api = {
  ...
  verifyPasswordResetOtp: (email, otp) => client.post('/auth/password-reset/verify', { email, otp }),
  completePasswordReset: (email, resetToken, password) =>
    client.post('/auth/password-reset/complete', { email, resetToken, password }),
